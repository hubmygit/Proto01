            ...
            else
            {
                ...
                foreach (Filter thisFilter in savedFilterControls)
                {
                    ...
                    if (thisFilter.FieldName == "txtProelKateuth")
                    {
                        ...
                        //filterValues.Add(thisFilter.FieldValue);
                        filterObjs.Add(new PrintFilterObj { filterNames = "Αποστολέας/Παραλήπτης:", filterValues = thisFilter.FieldValue });
                    ...
                    if (thisFilter.FieldName == "txtToText")
                    {
                        ...
                        //filterValues.Add(thisFilter.FieldValue);
                        filterObjs.Add(new PrintFilterObj { filterNames = "Αρμ.για ενέργεια/Παρατηρήσεις:", filterValues = thisFilter.FieldValue });
